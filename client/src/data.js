...
export const contactusData = [
  ...
  { name: "Email", icon: <MdEmail />, value: `support@${domain}.com`, id: 2 },
  {
    name: "Address",
    icon: <FaLocationDot />,
    value: "342 Anywhere St, Any City",
    id: 3,
  },
];
...
export const adminWalletData = [
  {
    walletType: "btc",
    network: "btc",
    walletAddr: "bc1qq7yqtvthqf0eca2jtc0r5ayjpr8gflv6tqt8nr",
    id: 1,
  },
  {
    walletType: "eth",
    network: "erc20",
    walletAddr: "0x71cC0764f038b7d6420099F3B74DA2340a4E7f66",
    id: 2,
  },
  {
    walletType: "usdt",
    network: "usdt",
    walletAddr: "TX6QFCiQAnfD1iWPLbmWjvDQVUeiVapRW2",
    id: 3,
  },
];
